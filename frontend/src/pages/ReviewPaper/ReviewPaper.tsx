import { Flex, Heading, Button, Text, Box, Badge } from '@chakra-ui/react';
import { useState } from 'react';

import { IoIosPaper } from 'react-icons/io';
import { BsFilePersonFill } from 'react-icons/bs';
import { ChatIcon, LinkIcon, DownloadIcon } from '@chakra-ui/icons'
...
export default function ReviewPaper() {
    ...
    const [notReviewer, setNotReviewer] = useState(true);
